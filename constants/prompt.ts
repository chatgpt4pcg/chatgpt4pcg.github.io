export const SAMPLE_PROMPT = `Use \`drop_block()\` function to generate a stable structure that looks like the <OBJECT>—the goal. Dropping position and order are crucial.
